...
const users = [
    { name: 'Admin User', email: 'admin@hackathon-feast.com', password: 'password123', role: 'admin' },
    { name: 'Demo User', email: 'user@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Alice Smith', email: 'alice@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Bob Johnson', email: 'bob@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Charlie Dave', email: 'charlie@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Diana Prince', email: 'diana@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Ethan Hunt', email: 'ethan@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Fiona Gallagher', email: 'fiona@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'George Miller', email: 'george@hackathon-feast.com', password: 'password123', role: 'user' },
    { name: 'Hannah Montana', email: 'hannah@hackathon-feast.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@hackathon-feast.com');
        console.log('User Email:  user@hackathon-feast.com');
